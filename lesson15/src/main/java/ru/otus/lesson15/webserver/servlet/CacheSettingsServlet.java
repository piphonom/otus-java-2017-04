...
import ru.otus.lesson15.webserver.helpers.ObjectToWebMapper;
import ru.otus.lesson15.webserver.helpers.WebToObjectMapper;
 ...
 * Created by piphonom
 */
public final class CacheSettingsServlet extends HttpServlet {
    ...
    public CacheSettingsServlet(Object handledObject, String username, String password) {
